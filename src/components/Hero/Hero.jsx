        ...
        <div className=' flex flex-col-reverse md:flex-row gap-10'>
           <div className='px-8 py-16 space-y-6'>
            ...
            <div className='flex justify-start items-center gap-4'>
                <button className='bg-white p-2 rounded-full'><FaFacebookF className='text-black text-xl' /></button>
                <button className='bg-white p-2 rounded-full'><FiGithub className='text-black text-xl' /></button>
            </div>
